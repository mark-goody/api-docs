...
<ResponseField name="order_batches" type="object[]">
  ...
  <Expandable title="order batch">
    ...
    <ResponseField name="funding_source" type="string | null">`card`, `balance`, `workspace_balance`, `corporate_account`, or `commerce_stored_value`; null when unknown or for commerce app orders. For a batch, this describes the selected funding source, not a combined payment result for its orders.</ResponseField>
    <ResponseField name="payment_method_id" type="string (uuid) | null">Goody card payment method UUID, including inactive cards. Null for account funding, commerce app orders, or when the card is unknown.</ResponseField>
  ...
  "order_batches": [
    {
      ...
      "funding_source": "card",
      "payment_method_id": "79eec4e2-9022-4d4d-b9e1-81ca2807db2f",
      "orders_count": 12,
      "recipients_count": 12,
    ...
    },
    {
      ...
      "funding_source": "workspace_balance",

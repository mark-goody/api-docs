...
<ResponseField name="order_batches" type="object[]">
  ...
  <Expandable title="order batch">
    ...
    <ResponseField name="payment_method_id" type="string | null">The funding source used for the batch. Card payments return the Goody payment method UUID; account-funded payments return `BALANCE`, `WORKSPACE_BALANCE`, `COMMERCE_STORED_VALUE`, or `CORPORATE_ACCOUNT`.</ResponseField>
...
```json ↩️ Result
{
  "order_batches": [
    ...
    },
    {
      ...
      "payment_method_id": "WORKSPACE_BALANCE",
      "orders_count": 3,
      "recipients_count": 3,

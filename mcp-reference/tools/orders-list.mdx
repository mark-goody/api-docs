...
<ResponseField name="orders" type="object[]">
  ...
  <Expandable title="order">
    ...
    <ResponseField name="payment_method_id" type="string | null">The funding source used for the order. Card payments return the Goody payment method UUID; account-funded payments return `BALANCE`, `WORKSPACE_BALANCE`, `COMMERCE_STORED_VALUE`, or `CORPORATE_ACCOUNT`.</ResponseField>
